  ...
  for alloc in allocs {
    {
      ...
      defer deleteArgumentOption(&ao)
      tc.expect(t, ok)
      usage := _getUsageString(&ao, PREFIX_RUNE)
      expected_usage := "[-l L]"
    ...
    }
    {
      ...
      defer deleteArgumentOption(&ao)
      tc.expect(t, ok)
      usage1 := _getUsageString(&ao, PREFIX_RUNE)
      expected_usage1 := "[pos?]"
      ...
      _clearCache(&ao)
      usage2 := _getUsageString(&ao, PREFIX_RUNE)
  ...
  for alloc in allocs {
    {
      ...
      defer deleteArgumentOption(&ao)
      tc.expect(t, ok)
      help_cache := _getHelpCache(&ao, PREFIX_RUNE)
